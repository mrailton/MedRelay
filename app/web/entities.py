...
def redirect_if_missing[T](entity: T | None, url: str = "/") -> ActionResult | T:
    if entity is None:
...
@overload
def split_entity[T](entity: T, url: str = "/") -> tuple[None, T]: ...


def split_entity[T](entity: T | None, url: str = "/") -> tuple[ActionResult | None, T | None]:
...
def resolved_entity[T](miss: ActionResult | None, entity: T | None) -> T:
